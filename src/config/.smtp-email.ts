...
// console.log("🚀 Configuration MailerSend chargée:", {
//   apiKey: envConfig.mailerSend.apiKey
//     ? "***" + envConfig.mailerSend.apiKey.slice(-4)
//     : "Non définie",
//   defaultFrom: envConfig.mailerSend.defaultFrom,
//   defaultFromName: envConfig.mailerSend.defaultFromName,
// });

// /**
//  * Instance MailerSend configurée
//  */
...
//   envConfig.mailerSend.defaultFrom,
//   envConfig.mailerSend.defaultFromName,
// );
...
//     // Note: MailerSend gère les attachments différemment,
//     // cette fonctionnalité pourra être ajoutée si nécessaire

//     const response = await mailerSend.email.send(emailParams);
//     console.log("📧 Email envoyé avec succès via MailerSend:", response);
//     return response;
//   } catch (error) {
//     console.error(
//       "❌ Erreur lors de l'envoi de l'email via MailerSend:",
//       error,
//     );
//     throw error;
//   }
...
// /**
//  * Vérifier la connexion MailerSend (simulation)
//  */
// export const verifySmtpConnection = async (): Promise<boolean> => {
//   try {
//     // MailerSend n'a pas de méthode verify comme nodemailer
//     // On peut tester en envoyant un email de test ou vérifier que l'API key est valide
//     if (!envConfig.mailerSend.apiKey) {
//       throw new Error("API Key MailerSend non configurée");
//     }
//     console.log("✅ Configuration MailerSend vérifiée avec succès");
//     return true;
//   } catch (error) {
//     console.error("❌ Erreur de configuration MailerSend:", error);
//     return false;
//   }
// };
...
//         ${firstName ? `<p>Bonjour ${firstName},</p>` : "<p>Bonjour,"}
...
//   // Template pour notifier a un freelance qu'il a recu une proposition de contrat
//   contractProposed: (
//     projectTitle: string,
//     freelanceName: string,
//     companyName?: string,
